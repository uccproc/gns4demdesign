...
def main(unused_argv):
  ...
  base_name_with_extension = os.path.basename(FLAGS.rollout_path)
  base_name_without_extension = os.path.splitext(base_name_with_extension)[0]
  name = base_name_without_extension + '.gif'
  # name = FLAGS.rollout_path.strip()[-13:].strip('.pkl') + '.gif'
  fullpath = "E:/OneDrive - University College Cork/recap_2310_12/GNS_for_2D_Dambreak_frictionrestitution/rollouts/17_granular_2D_50_friction_restitution_DoE_2nd/" + name
  # fullpath = "E:/OneDrive - University College Cork/recap_2310_12/GNS_for_2D_Dambreak/rollouts/16_Dambreak_500/case3_mp3_r004_0/" + 'optimized_9.gif'
  writergif = animation.PillowWriter(fps=10)
  unused_animation.save(fullpath, writer=writergif)
